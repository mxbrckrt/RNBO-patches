...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 152.0, 80.0, 92.0, 35.0 ],
					"text" : ";\rkillswitch-vol -70"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 152.0, 15.0, 142.0, 48.0 ],
					"text" : ";\rkillswitch-vol -70 0 2000 0;\r"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 59.0, 225.0, 71.0, 22.0 ],
					"text" : "dac~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 59.0, 62.0, 39.0, 22.0 ],
					"text" : "*~ 0.2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 59.0, 32.0, 69.0, 22.0 ],
					"text" : "cycle~ 1000"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 59.0, 137.0, 175.0, 22.0 ],
					"text" : "poly~ poly-killswitch 1 @parallel 1",
					"varname" : "poly~"
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-1.1::obj-2" : [ "live.gain~", "live.gain~", 0 ],
			"obj-1.1::obj-29" : [ "live.text", "live.text", 0 ],
			"parameterbanks" : 			{
				"0" : 				{
					"index" : 0,
					"name" : "",
...
, 			{
				"name" : "poly-killswitch.maxpat",
				"bootpath" : "~/Documents/__Taaaf/1-MaxMspPatches/-new-freak-/--several-devs-/cswitch",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
