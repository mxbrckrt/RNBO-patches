...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"color" : [ 0.047058823529412, 0.376470588235294, 0.0, 1.0 ],
					"id" : "obj-45",
					"maxclass" : "newobj",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 624.0, 379.0, 52.0, 22.0 ],
					"text" : "r~ sound"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 387.0, 379.0, 52.0, 22.0 ],
					"text" : "r~ sound"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 172.0, 188.0, 52.0, 22.0 ],
					"text" : "r~ sound"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 458.0, 108.0, 52.0, 22.0 ],
					"text" : "s~ sound"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 677.0, 448.0, 22.0, 140.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 441.0, 448.0, 22.0, 140.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 441.0, 279.0, 110.0, 22.0 ],
					"text_width" : 64.0
				}
...
,
					"patching_rect" : [ 491.0, 239.0, 57.0, 22.0 ],
...
, 			{
				"box" : 				{
					"id" : "obj-12",
					"items" : [ "Default", ",", "AM", ",", "High", ",", "Extreme", ",", "Tremolo", ",", "Wide", ",", "Subtle" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 441.0, 239.0, 110.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"attr_display" : 1,
					"displaymode" : 8,
					"hint" : "Inverts the polarity of the right channel, creating a stereo effect",
					"id" : "obj-24",
					"lock" : 1,
					"maxclass" : "attrui",
					"numinlets" : 1,
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 441.0, 351.0, 110.0, 22.0 ],
					"text_width" : 64.0
				}
...
, 			{
				"box" : 				{
					"attr" : "freq",
					"attr_display" : 1,
					"hint" : "Sets the frequency of the modulation oscillator",
					"id" : "obj-25",
					"lock" : 1,
					"maxclass" : "attrui",
					"numinlets" : 1,
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 441.0, 303.0, 110.0, 22.0 ],
					"text_width" : 64.0
				}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 620.0, 660.0, 41.0, 18.0 ],
									"text" : "Params"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 520.0, 660.0, 27.0, 18.0 ],
									"text" : "Tips"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 584.0, 660.0, 32.0, 18.0 ],
									"text" : "Copy"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 550.0, 660.0, 30.0, 18.0 ],
									"text" : "Help"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 550.0, 680.0, 111.0, 18.0 ],
...
,
					"patching_rect" : [ 441.0, 412.0, 79.0, 25.0 ],
					"rnboattrcache" : 					{
						"freq" : 						{
							"label" : "freq",
							"isEnum" : 0,
...
,
									"fileref" : 									{
										...
										"filepos" : -1,
										"snapshotfileid" : "b017ecc89896e2042e26dd955610e237"
									}
...
, 								{
									...
									"fileref" : 									{
										...
										"filepath" : "~/Documents/Max 8/Snapshots",
										"filepos" : -1,
										"snapshotfileid" : "8b0c6855445a9f508a46886bced74dfb"
									}
...
, 								{
									...
									"fileref" : 									{
										...
										"filepath" : "~/Documents/Max 8/Snapshots",
										"filepos" : -1,
										"snapshotfileid" : "b07eeb2fcab92438ab73146ea8f04441"
									}
...
, 								{
									...
									"fileref" : 									{
										...
										"filepath" : "~/Documents/Max 8/Snapshots",
										"filepos" : -1,
										"snapshotfileid" : "75d5c7ba92c13eb6d9333d4da8c64751"
									}
...
, 			{
				"box" : 				{
					"attr" : "mode",
					"attr_display" : 1,
					"hint" : "Toggles between ring (RM) and amplitude (AM) modulation modes",
					"id" : "obj-38",
					"lock" : 1,
					"maxclass" : "attrui",
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					"attr" : "spread",
					"attr_display" : 1,
					"hint" : "Adjusts the mix from positive sidebands for both left and right channels to positive sidebands for left channel and negative (opposite) sidebands for right channel",
					"id" : "obj-1",
					"lock" : 1,
					"maxclass" : "attrui",
					"numinlets" : 1,
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 677.0, 322.0, 110.0, 22.0 ],
					"text_width" : 64.0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 677.0, 346.0, 110.0, 22.0 ],
					"text_width" : 64.0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 677.0, 274.0, 110.0, 22.0 ],
					"text_width" : 64.0
				}
...
,
					"patching_rect" : [ 727.0, 234.0, 57.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					"id" : "obj-29",
					"items" : [ "Default", ",", "High", ",", "Low", ",", "Wide", ",", "Phasing", ",", "Spinning", ",", "Extreme", ",", "Subtle" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 677.0, 234.0, 110.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					"attr" : "freq",
					"attr_display" : 1,
					"hint" : "Sets the amount of frequency shift that is applied to the input",
					"id" : "obj-2",
					"lock" : 1,
					"maxclass" : "attrui",
					"numinlets" : 1,
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 677.0, 298.0, 110.0, 22.0 ],
					"text_width" : 64.0
				}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 440.0, 350.0, 50.0, 23.0 ],
									"rnbo_classname" : "number",
									"rnbo_extra_attributes" : 									{
										"minimum" : "<none>",
										"maximum" : "<none>",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 440.0, 320.0, 113.0, 23.0 ],
									"rnbo_classname" : "scale",
									"rnbo_serial" : 2,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "signal", "" ],
									"patching_rect" : [ 440.0, 380.0, 69.0, 23.0 ],
									"rnbo_classname" : "fade~",
									"rnbo_serial" : 1,
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 440.0, 290.0, 50.0, 23.0 ],
									"rnbo_classname" : "number",
									"rnbo_extra_attributes" : 									{
										"minimum" : "<none>",
										"maximum" : "<none>",
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 440.0, 470.0, 50.0, 23.0 ],
									"rnbo_classname" : "number",
									"rnbo_extra_attributes" : 									{
										"minimum" : "<none>",
										"maximum" : "<none>",
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 440.0, 530.0, 50.0, 23.0 ],
									"rnbo_classname" : "number",
									"rnbo_extra_attributes" : 									{
										"minimum" : "<none>",
										"maximum" : "<none>",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 440.0, 440.0, 63.0, 23.0 ],
									"rnbo_classname" : "param",
									"rnbo_extra_attributes" : 									{
										"minimum" : 0.0,
										"sendinit" : 1,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "signal", "" ],
									"patching_rect" : [ 440.0, 560.0, 69.0, 23.0 ],
									"rnbo_classname" : "fade~",
									"rnbo_serial" : 2,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 440.0, 260.0, 79.0, 23.0 ],
									"rnbo_classname" : "param",
									"rnbo_extra_attributes" : 									{
										"minimum" : 0.0,
										"sendinit" : 1,
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 460.0, 70.0, 212.0, 78.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 420.0, 470.0, 20.0, 21.0 ],
									"text" : "%"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 420.0, 290.0, 20.0, 21.0 ],
									"text" : "%"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 20.0, 40.0, 27.0, 18.0 ],
									"text" : "Tips"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 84.0, 40.0, 32.0, 18.0 ],
									"text" : "Copy"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 50.0, 40.0, 30.0, 18.0 ],
									"text" : "Help"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 50.0, 60.0, 111.0, 18.0 ],
									"text" : "manuel@cycling74.com"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 460.0, 30.0, 154.0, 28.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 460.0, 50.0, 176.0, 21.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 440.0, 190.0, 232.0, 64.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 495.0, 350.0, 38.0, 21.0 ],
									"text" : "[0. 1.]"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 495.0, 290.0, 45.0, 21.0 ],
									"text" : "Spread"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 510.0, 380.0, 70.0, 21.0 ],
									"text" : "10 ms ramp"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 510.0, 560.0, 70.0, 21.0 ],
									"text" : "10 ms ramp"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 495.0, 470.0, 29.0, 21.0 ],
									"text" : "Mix"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 495.0, 530.0, 38.0, 21.0 ],
									"text" : "[0. 1.]"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 530.0, 440.0, 131.0, 50.0 ],
...
,
							"web-export" : 							{
								"json-web-export" : 								{
									"file_name" : "rnbo.freqshifter.json"
								}
...
,
					"patching_rect" : [ 677.0, 407.0, 79.0, 25.0 ],
					"rnboattrcache" : 					{
						"spread" : 						{
							"label" : "spread",
							"isEnum" : 0,
...
,
									"fileref" : 									{
										...
										"filepath" : "~/Documents/Max 8/Snapshots",
										"filepos" : -1,
										"snapshotfileid" : "404c41874adf4f9596092d967dc92ab8"
									}
...
,
									"fileref" : 									{
										...
										"filepath" : "~/Documents/Max 8/Snapshots",
										"filepos" : -1,
										"snapshotfileid" : "ba3a1ed95b9f60747a01b3dac385e046"
									}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 735.5, 66.5, 152.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 734.5, 42.5, 154.0, 23.0 ]
				}
...
,
									"patching_rect" : [ 24.0, 120.0, 200.5, 23.0 ],
									"rnbo_classname" : "p",
									"rnbo_extra_attributes" : 									{
										"args" : [  ],
										"polyphony" : -1.0,
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 24.0, 148.0, 43.0, 23.0 ],
									"rnbo_classname" : "out~",
									"rnbo_extra_attributes" : 									{
										"comment" : "",
										"meta" : ""
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 24.0, 39.333333333333314, 35.0, 23.0 ],
									"rnbo_classname" : "in~",
									"rnbo_extra_attributes" : 									{
										"comment" : "",
										"meta" : ""
...
,
									"patching_rect" : [ 24.0, 92.0, 200.5, 23.0 ],
									"rnbo_classname" : "p",
									"rnbo_extra_attributes" : 									{
										"args" : [  ],
										"polyphony" : -1.0,
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 206.300000000000068, 64.333333333333314, 50.0, 23.0 ],
									"rnbo_classname" : "number",
									"rnbo_extra_attributes" : 									{
										"minimum" : "<none>",
										"maximum" : "<none>",
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 114.75, 39.333333333333314, 50.0, 23.0 ],
									"rnbo_classname" : "number",
									"rnbo_extra_attributes" : 									{
										"minimum" : "<none>",
										"maximum" : "<none>",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 206.300000000000068, 39.333333333333314, 285.0, 23.0 ],
									"rnbo_classname" : "param",
									"rnbo_extra_attributes" : 									{
										"sendinit" : 1,
										"displayname" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 114.75, 13.0, 267.0, 23.0 ],
									"rnbo_classname" : "param",
									"rnbo_extra_attributes" : 									{
										"sendinit" : 1,
										"displayname" : "",
...
,
					"patching_rect" : [ 711.5, 103.5, 41.0, 23.0 ],
					"rnboattrcache" : 					{
						"lowcut" : 						{
							"label" : "lowcut",
							"isEnum" : 0,
...
,
					"saved_object_attributes" : 					{
						"optimization" : "O1",
						"parameter_enable" : 1,
						"uuid" : "4606bbfb-1358-11ef-bbfb-a29ad4ace4ad"
					}
,
					"snapshot" : 					{
						"filetype" : "C74Snapshot",
...
,
							"__presetid" : "4606bbfb-1358-11ef-bbfb-a29ad4ace4ad"
						}
,
						"snapshotlist" : 						{
							"current_snapshot" : 0,
							"entries" : [ 								{
									...
									"minorversion" : 0,
									"name" : "untitled",
									"origin" : "4606bbfb-1358-11ef-bbfb-a29ad4ace4ad",
									"type" : "rnbo",
									"subtype" : "",
									"embed" : 0,
									"snapshot" : 									{
...
,
									"fileref" : 									{
										"name" : "untitled",
										"filename" : "untitled_20240516.maxsnap",
										"filepath" : "~/Documents/Max 8/Snapshots",
										"filepos" : -1,
										"snapshotfileid" : "cd977b9da4a46e0a35b8fa470702fcfc"
									}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 136.5, 598.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 33.5, 448.0, 22.0, 140.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 136.5, 663.0, 33.0, 22.0 ],
					"text" : "dac~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 196.5, 448.0, 22.0, 140.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"data" : 					{
						"clips" : [ 							{
								"absolutepath" : "/Users/max/Documents/__Sooons/__Maxmsp-sfiles-test/_Aperghis-donatienne-micheldansac-recitations-part1.wav",
...
,
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 458.0, 34.0, 233.0, 66.0 ],
					"pitchcorrection" : 0,
					"quality" : "basic",
					"timestretch" : [ 0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 182.5, 12.0, 38.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 110.453673999999864, 59.5, 29.0, 20.0 ],
					"text" : "gain",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 235.5, 34.0, 122.0, 35.0 ],
					"text" : "m-meg ringmod-gain @hint @autoname"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 182.5, 34.0, 49.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 59.453673999999978, 62.0, 48.999999999999886, 15.0 ],
					"saved_attribute_attributes" : 					{
						"activebgcolor" : 						{
							"expression" : ""
						}
...
,
						"valueof" : 						{
							...
							"parameter_longname" : "ringmod-gain",
							"parameter_mmax" : 3.0,
							"parameter_modmode" : 0,
							"parameter_shortname" : "ringmod-gain",
							"parameter_type" : 0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 99.0, 124.0, 31.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 133.453673999999864, 8.0, 31.0, 20.0 ],
					"text" : "freq ",
					"textcolor" : [ 0.490196, 0.490196, 0.490196, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 188.166666666666686, 91.5, 122.0, 35.0 ],
...
,
									"patching_rect" : [ 720.0, 470.0, 200.5, 23.0 ],
									"rnbo_classname" : "p",
									"rnbo_extra_attributes" : 									{
										"args" : [  ],
										"polyphony" : -1.0,
...
,
									"patching_rect" : [ 720.0, 350.0, 200.5, 23.0 ],
									"rnbo_classname" : "p",
									"rnbo_extra_attributes" : 									{
										"args" : [  ],
										"polyphony" : -1.0,
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 902.0, 322.0, 50.0, 23.0 ],
									"rnbo_classname" : "number",
									"rnbo_extra_attributes" : 									{
										"minimum" : "<none>",
										"maximum" : "<none>",
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 811.0, 297.0, 50.0, 23.0 ],
									"rnbo_classname" : "number",
									"rnbo_extra_attributes" : 									{
										"minimum" : "<none>",
										"maximum" : "<none>",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 902.0, 297.0, 285.0, 23.0 ],
									"rnbo_classname" : "param",
									"rnbo_extra_attributes" : 									{
										"sendinit" : 1,
										"displayname" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 811.0, 271.0, 267.0, 23.0 ],
									"rnbo_classname" : "param",
									"rnbo_extra_attributes" : 									{
										"sendinit" : 1,
										"displayname" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 508.0, 304.0, 28.0, 23.0 ],
									"rnbo_classname" : "in",
									"rnbo_extra_attributes" : 									{
										"comment" : "ringmod gain",
										"meta" : ""
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 382.0, 71.0, 81.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 339.0, 65.0, 28.0, 23.0 ],
									"rnbo_classname" : "in",
									"rnbo_extra_attributes" : 									{
										"comment" : "frequency offset (default 100%)",
										"meta" : ""
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 247.0, 65.0, 28.0, 23.0 ],
									"rnbo_classname" : "in",
									"rnbo_extra_attributes" : 									{
										"comment" : "frequency",
										"meta" : ""
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 117.0, 493.0, 56.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 247.0, 267.0, 113.0, 23.0 ],
									"rnbo_classname" : "clip",
									"rnbo_extra_attributes" : 									{
										"hot" : 0
									}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 338.0, 140.0, 41.0, 23.0 ],
									"rnbo_classname" : "/",
									"rnbo_extra_attributes" : 									{
										"hot" : 0
									}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 338.0, 180.0, 30.0, 23.0 ],
									"rnbo_classname" : "t",
									"rnbo_extra_attributes" : 									{
										"triggers" : ""
									}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 247.0, 205.0, 29.5, 23.0 ],
									"rnbo_classname" : "f",
									"rnbo_extra_attributes" : 									{
										"initial" : 0.0
									}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 508.0, 368.0, 44.0, 23.0 ],
									"rnbo_classname" : "t",
									"rnbo_extra_attributes" : 									{
										"triggers" : ""
									}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 508.0, 336.0, 50.0, 23.0 ],
									"rnbo_classname" : "number",
									"rnbo_extra_attributes" : 									{
										"minimum" : "<none>",
										"maximum" : "<none>",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "signal", "" ],
									"patching_rect" : [ 508.0, 399.0, 44.0, 23.0 ],
									"rnbo_classname" : "line~",
									"rnbo_serial" : 1,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 117.0, 458.0, 408.75006099999996, 23.0 ],
									"rnbo_classname" : "*~",
									"rnbo_serial" : 1,
									"rnbo_uniqueid" : "*~_obj-12",
									"text" : "*~ 1."
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 117.0, 533.0, 43.0, 23.0 ],
									"rnbo_classname" : "out~",
									"rnbo_extra_attributes" : 									{
										"comment" : "audio out",
										"meta" : ""
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 117.0, 65.0, 35.0, 23.0 ],
									"rnbo_classname" : "in~",
									"rnbo_extra_attributes" : 									{
										"comment" : "audio in",
										"meta" : ""
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 247.0, 102.0, 50.0, 23.0 ],
									"rnbo_classname" : "number",
									"rnbo_extra_attributes" : 									{
										"minimum" : "<none>",
										"maximum" : "<none>",
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 338.0, 102.0, 50.0, 23.0 ],
									"rnbo_classname" : "number",
									"rnbo_extra_attributes" : 									{
										"minimum" : "<none>",
										"maximum" : "<none>",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 247.0, 238.0, 121.0, 23.0 ],
									"rnbo_classname" : "*",
									"rnbo_extra_attributes" : 									{
										"hot" : 0
									}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 247.0, 326.0, 44.0, 23.0 ],
									"rnbo_classname" : "t",
									"rnbo_extra_attributes" : 									{
										"triggers" : ""
									}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 247.0, 297.0, 61.0, 23.0 ],
									"rnbo_classname" : "number",
									"rnbo_extra_attributes" : 									{
										"minimum" : "<none>",
										"maximum" : "<none>",
...
,
									...
									"numoutlets" : 2,
									"outlettype" : [ "signal", "signal" ],
									"patching_rect" : [ 246.0, 395.0, 92.0, 23.0 ],
									"rnbo_classname" : "gen~",
									"rnbo_extra_attributes" : 									{
										"exposeparams" : 0
									}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 319.0, 362.0, 43.0, 23.0 ],
									"rnbo_classname" : "sig~",
									"rnbo_extra_attributes" : 									{
										"unit" : "ms"
									}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "signal", "" ],
									"patching_rect" : [ 247.0, 362.0, 44.0, 23.0 ],
									"rnbo_classname" : "line~",
									"rnbo_serial" : 2,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 117.0, 426.0, 147.75006099999996, 23.0 ],
									"rnbo_classname" : "*~",
									"rnbo_serial" : 2,
						...
						"export_config" : 						{
							"max-export" : 							{
								"max-external-export" : 								{
									...
									"author" : "max bruckert",
									"mc" : 1,
									"description" : "simple ringmodulation voice with frequency, frequency offset and gain",
									"tags" : "ringmodulation"
								}
...
,
					"patching_rect" : [ 196.5, 222.0, 161.5, 25.0 ],
					"rnboattrcache" : 					{
						"lowcut" : 						{
							"label" : "lowcut",
							"isEnum" : 0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 135.166666666666686, 91.5, 49.0, 15.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 135.166666666666686, 69.5, 63.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 110.453673999999864, 25.5, 63.0, 20.0 ],
					"text" : "freq  offset",
					"textcolor" : [ 0.490196, 0.490196, 0.490196, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 149.0, 146.0, 114.0, 35.0 ],
					"text" : "m-meg ringmod-freq @hint @autoname"
				}
...
, 			{
				"box" : 				{
					...
					"activeslidercolor" : [ 0.317647, 0.654902, 0.976471, 1.0 ],
					"activetricolor2" : [ 0.094117647058824, 0.309803921568627, 0.407843137254902, 1.0 ],
					"annotation" : "",
					"bordercolor" : [ 0.094117647058824, 0.309803921568627, 0.407843137254902, 1.0 ],
					"focusbordercolor" : [ 0.094117647058824, 0.309803921568627, 0.407843137254902, 1.0 ],
					"hint" : "ringmod-freq",
					"id" : "obj-39",
					"maxclass" : "live.numbox",
					"numinlets" : 1,
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 99.0, 146.0, 40.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 59.453673999999978, 10.5, 71.999999999999886, 15.0 ],
					"saved_attribute_attributes" : 					{
						"activebgcolor" : 						{
							"expression" : ""
						}
...
,
						"valueof" : 						{
							...
							"parameter_modmode" : 0,
							"parameter_shortname" : "ringmod-freq",
							"parameter_type" : 0,
							"parameter_unitstyle" : 1
						}
...
,
					"textcolor" : [ 0.094117647058824, 0.309803921568627, 0.407843137254902, 1.0 ],
					"varname" : "ringmod-freq"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 644.0, 301.0, 20.0, 18.0 ],
					"text" : "Cc",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 657.0, 325.0, 18.0, 18.0 ],
					"text" : "2",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 657.0, 349.0, 19.0, 18.0 ],
					"text" : "3",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 657.0, 301.0, 18.0, 18.0 ],
					"text" : "1",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 787.0, 325.0, 18.0, 18.0 ],
					"text" : "%",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 677.0, 256.0, 110.0, 18.0 ],
					"text" : "Parameters",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 787.0, 349.0, 18.0, 18.0 ],
					"text" : "%",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 421.0, 330.0, 18.0, 18.0 ],
					"text" : "2",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 421.0, 354.0, 19.0, 18.0 ],
					"text" : "3",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 421.0, 306.0, 18.0, 18.0 ],
					"text" : "1",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 441.0, 262.0, 110.0, 18.0 ],
					"text" : "Parameters",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 787.0, 301.0, 18.0, 18.0 ],
					"text" : "%",
					"textjustification" : 1
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-143" : [ "rnbo~[1]", "rnbo~", 0 ],
			"obj-17" : [ "ringmod-gain", "ringmod-gain", 0 ],
			"obj-27" : [ "rnbo~[3]", "rnbo~", 0 ],
			"obj-3" : [ "rnbo~", "rnbo~", 0 ],
			"obj-39" : [ "ringmod-freq", "ringmod-freq", 0 ],
			"obj-43" : [ "rnbo~[2]", "rnbo~", 0 ],
			"parameterbanks" : 			{
				"0" : 				{
					"index" : 0,
					"name" : "",
...
,
		"dependency_cache" : [ 			{
				"name" : "Default[1]_20200917_3.maxsnap",
...
, 			{
				"name" : "untitled_20240516.maxsnap",
				"bootpath" : "~/Documents/Max 8/Snapshots",
				"patcherrelativepath" : "../../../../../../Max 8/Snapshots",
				"type" : "mx@s",
				"implicit" : 1
