...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 131.0, 273.0, 22.0, 140.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 78.0, 204.0, 52.0, 22.0 ],
					"text" : "r~ sound"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 131.0, 147.0, 110.0, 22.0 ],
					"text_width" : 64.0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 131.0, 99.0, 110.0, 22.0 ],
					"text_width" : 64.0
				}
...
,
					"patching_rect" : [ 241.0, 50.0, 57.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 191.0, 50.0, 110.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 131.0, 123.0, 110.0, 22.0 ],
					"text_width" : 64.0
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 210.0, 170.0, 134.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 150.0, 110.0, 79.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 100.0, 320.0, 69.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 150.0, 220.0, 60.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 150.0, 140.0, 143.0, 23.0 ],
									"rnbo_classname" : "scale",
									"rnbo_serial" : 3,
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 190.0, 310.0, 50.0, 23.0 ],
									"rnbo_classname" : "number",
									"rnbo_extra_attributes" : 									{
										"minimum" : "<none>",
										"maximum" : "<none>",
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 190.0, 370.0, 50.0, 23.0 ],
									"rnbo_classname" : "number",
									"rnbo_extra_attributes" : 									{
										"minimum" : "<none>",
										"maximum" : "<none>",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 60.0, 510.0, 43.0, 23.0 ],
									"rnbo_classname" : "out~",
									"rnbo_extra_attributes" : 									{
										"comment" : "",
										"meta" : ""
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 60.0, 470.0, 100.0, 23.0 ],
									"rnbo_classname" : "mix~",
									"rnbo_serial" : 3,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 190.0, 280.0, 63.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "signal", "" ],
									"patching_rect" : [ 190.0, 400.0, 69.0, 23.0 ],
									"rnbo_classname" : "fade~",
									"rnbo_serial" : 2,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 190.0, 340.0, 113.0, 23.0 ],
									"rnbo_classname" : "scale",
									"rnbo_serial" : 4,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "signal", "" ],
									"patching_rect" : [ 150.0, 250.0, 69.0, 23.0 ],
									"rnbo_classname" : "fade~",
									"rnbo_serial" : 3,
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 150.0, 80.0, 50.0, 23.0 ],
									"rnbo_classname" : "number",
									"rnbo_extra_attributes" : 									{
										"minimum" : "<none>",
										"maximum" : "<none>",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 150.0, 40.0, 66.0, 23.0 ],
									"rnbo_classname" : "param",
									"rnbo_extra_attributes" : 									{
										"value" : 25.0,
										"enum" : "",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 130.0, 80.0, 20.0, 21.0 ],
									"text" : "%"
								}
...
,
					"patching_rect" : [ 131.0, 232.0, 79.0, 25.0 ],
					"rnboattrcache" : 					{
						"mix" : 						{
							"label" : "mix",
							"isEnum" : 0,
...
,
									"fileref" : 									{
										...
										"filepath" : "~/Documents/Max 8/Snapshots",
										"filepos" : -1,
										"snapshotfileid" : "aaff4b148e6b13d35a8961ba67c19ae4"
									}
...
, 								{
									...
									"fileref" : 									{
										...
										"filepath" : "~/Documents/Max 8/Snapshots",
										"filepos" : -1,
										"snapshotfileid" : "3dd2f7673f2d9453b1e28a4531f375a9"
									}
...
, 								{
									...
									"fileref" : 									{
										...
										"filepath" : "~/Documents/Max 8/Snapshots",
										"filepos" : -1,
										"snapshotfileid" : "ebbd024106e9064b0478157dafd2a936"
									}
...
, 								{
									...
									"fileref" : 									{
										...
										"filepath" : "~/Documents/Max 8/Snapshots",
										"filepos" : -1,
										"snapshotfileid" : "7fd4b41ee1f66f97c3145906afc52751"
									}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 79.0, 417.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 131.0, 433.0, 51.0, 22.0 ],
					"text" : "dac~"
				}
...
,
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 292.0, 215.0, 233.0, 66.0 ],
					"pitchcorrection" : 0,
					"quality" : "basic",
					"timestretch" : [ 0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 98.0, 126.0, 20.0, 18.0 ],
					"text" : "Cc",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 111.0, 150.0, 19.0, 18.0 ],
					"text" : "3",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 111.0, 126.0, 18.0, 18.0 ],
					"text" : "1",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 131.0, 81.0, 110.0, 18.0 ],
					"text" : "Parameters",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 241.0, 150.0, 18.0, 18.0 ],
					"text" : "%",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 241.0, 126.0, 18.0, 18.0 ],
					"text" : "%",
					"textjustification" : 1
				}
...
, 			{
				"name" : "Default[1]_20200918.maxsnap",
				"bootpath" : "~/Documents/Max 8/Snapshots",
				"patcherrelativepath" : "../../../../../../Max 8/Snapshots",
				"type" : "mx@s",
				"implicit" : 1
