...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 7,
					"outlettype" : [ "", "", "", "", "", "", "" ],
					"patching_rect" : [ 92.0, 114.0, 213.333333333333314, 35.0 ],
					"text" : "route delay feedback grains proba env prepost"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 59.0, 205.0, 42.0, 22.0 ],
					"text" : "out~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 92.0, 80.0, 28.0, 22.0 ],
					"saved_object_attributes" : 					{
						"attr_comment" : [ "messages", ":", "del/feedback/grain", "dura°/grain", "proba/env", "type/prepost", "delay" ]
					}
,
					"text" : "in 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 59.0, 162.0, 215.0, 22.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0,
